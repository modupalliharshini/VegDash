...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '800', color: theme.colors.primaryText, fontFamily: 'Outfit', marginBottom: 12 },
  ...
  btn: { backgroundColor: theme.colors.primaryGreen, borderRadius: 16, height: 52, alignItems: 'center', justifyContent: 'center', width: '100%', marginBottom: 12 },
  btnText: { color: '#FFFFFF', fontSize: 16, fontWeight: '700', fontFamily: 'Outfit' },
  resendBtn: { padding: 12 },
  resendText: { fontSize: 14, fontWeight: '700', color: theme.colors.primaryGreen, fontFamily: 'Outfit' },
});
